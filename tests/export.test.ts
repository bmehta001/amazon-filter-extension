...
describe("exportToCsv edge cases", () => {
  it("escapes newlines in field values", () => {
    const row: ExportRow = {
      ...
      dealScore: null, multiBuyOffer: "", bsrRank: null, bsrCategory: "", reviewSummary: "", url: "https://amazon.com/dp/B001",
    };
...
describe("exportToClipboard edge cases", () => {
  ...
  it("does not escape tabs in values (raw TSV)", () => {
    ...
    expect(cols.length).toBeGreaterThan(20); // header has 23 cols, extra from embedded tab
  });
});
